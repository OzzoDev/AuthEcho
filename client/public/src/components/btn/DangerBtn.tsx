...
export default function DangerBtn({
  ...
  return (
    <button
      ...
      className={`flex justify-center items-center ${width} h-fit text-white font-semibold py-[10px] px-[25px] rounded-full transition-opacity duration-500 cursor-pointer group bg-gradient-to-b from-rose-600 to-pink-700 hover:opacity-60`}>
      {icon && (
